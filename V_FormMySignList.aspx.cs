...
public partial class FormMySignList : System.Web.UI.Page
{
    ...
    protected DataTable getResult()
    {
        ...
        try
        {
            ...
            dt = DBAccessProc.GetDataTable("GA_CarManagerment_PK0338_GetMySignList", 0, 1, sbrep.ToString(), sbval.ToString(), "{?,?}", out msg, out effectRow);

            if ("" != msg)
            {
                Response.Write("GA_CarManagerment_PK0338_GetMySignList Failure:" + msg);
                return null;
            }
        }
        catch (Exception ex)
        {
            Response.Write("GA_CarManagerment_PK0338_GetMySignList function error,Detail:" + ex.Message);
        }
        return dt;
    }
