<%@ Page Title="" Language="C#" MasterPageFile="~/eHRMaster.master" AutoEventWireup="true" CodeFile="V_FormReSend.aspx.cs" Inherits="FormReSend" %>
                ...
                OnRowCommand="GridView_RowCommand">
                            <Columns>
                                <asp:BoundField HeaderText="行號" ReadOnly="true" />
                                 <asp:TemplateField HeaderText="表單ID" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="txtFormID" runat="server" Text='<%# Eval("FormID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="流程名稱" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="txtFormType" runat="server" Text='<%# Eval("FormType") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="表單日期" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="txtFormDate" runat="server" Text='<%# Eval("ApplyDate","{0:yyyy-MM-dd}").ToString() %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="表單名稱" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="txtFormTypeName" runat="server" Text='<%# Eval("FormTypeName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <%--<asp:BoundField DataField="FormTypeName" HeaderText="表單類別"/>--%>
                                
                                <asp:TemplateField HeaderText="當前人">
                                    <ItemTemplate>
                                        <asp:Label ID="txtOwnerListName" runat="server" Text='<%# Eval("OwnerListName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="當前工號" Visible="false">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="代理人">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="ddlAgent" runat="server" AutoPostBack="true" CssClass="ddlStyle" BackColor="White"></asp:DropDownList>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="重送意見">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtComment" runat="server" TextMode="MultiLine" Text="重送!" CssClass="txtStyle"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="重送">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnResend"  OnClientClick= "return confirm('是否要重送？')" runat="server" 
                                            CausesValidation="False"  CommandArgument='<%# Bind("FormID") %>' CommandName="BtnReSend" 
                                            Text="重送">
                                        </asp:LinkButton>
                                    </ItemTemplate>
