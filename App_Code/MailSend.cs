...
{
    public static void SendMailMemo(string mailfrom, string fromName, string sendto, string ccto, string bccto, string mailsubject, string mailbody, string senderr)
    {
        try
        {
        ...
        catch
        {
            ...
            MailAddress bcc_err = new MailAddress(senderr);
